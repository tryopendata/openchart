...
For chart selection reasoning, color strategy, editorial writing, typography hierarchy, and design review checklists, load `Skill(data-visualization)` and consult its design philosophy references.
