...
const spec = {
  ...
  annotations: [
    ...
    // Highlighted range
    { type: 'range', x1: '2020-01-01', x2: '2020-07-01', label: 'COVID impact', opacity: 0.1 },
  ],
};
```
...
columns: [
  { key: 'city', label: 'City' },
  { key: 'temperature', label: 'Temp', format: '.1f', heatmap: { palette: 'redBlue' } },
]
```
...
columns: [
  { key: 'name', label: 'Name' },
  { key: 'trend', label: '12-Month Trend', sparkline: { type: 'line', valuesField: 'trend' } },
]
```
